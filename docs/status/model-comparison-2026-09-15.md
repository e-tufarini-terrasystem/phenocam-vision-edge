...
Il nuovo artefatto migliora il rilevamento delle **auto su PKLot e Raspberry**, anche rispetto al precedente specializzato v5, alla stessa configurazione operativa. Non risulta migliore in generale.
...
- Nessuna sovrapposizione esatta di hash tra le immagini valutate e il training v6. Questo controllo non dimostra indipendenza di camere, giorni o fotogrammi simili.
...
| PKLot holdout | v5 | 282 | 50 | 1004 | 0.849 | 0.219 | 0.349 |
| PKLot holdout | v6 | 882 | 91 | 404 | 0.906 | 0.686 | 0.781 |
| Raspberry | base | 1644 | 93 | 3184 | 0.946 | 0.341 | 0.501 |
| Raspberry | v5 | 1730 | 112 | 3098 | 0.939 | 0.358 | 0.519 |
| Raspberry | v6 | 2042 | 243 | 2786 | 0.894 | 0.423 | 0.574 |
| TS02 | base | 576 | 16 | 154 | 0.973 | 0.789 | 0.871 |
| TS02 | v5 | 595 | 18 | 135 | 0.971 | 0.815 | 0.886 |
| TS02 | v6 | 597 | 29 | 133 | 0.954 | 0.818 | 0.881 |
| Scene miste TEST-ID | base | 44 | 37 | 30 | 0.543 | 0.595 | 0.568 |
| Scene miste TEST-ID | v5 | 45 | 40 | 29 | 0.529 | 0.608 | 0.566 |
| Scene miste TEST-ID | v6 | 41 | 81 | 33 | 0.336 | 0.554 | 0.418 |
...
| PKLot holdout | v5 | 0 | 0 | 12 | 0.000 | 0.000 | 0.000 |
| PKLot holdout | v6 | 1 | 2 | 11 | 0.333 | 0.083 | 0.133 |
| Raspberry | base | 45 | 1 | 96 | 0.978 | 0.319 | 0.481 |
| Raspberry | v5 | 47 | 1 | 94 | 0.979 | 0.333 | 0.497 |
| Raspberry | v6 | 45 | 0 | 96 | 1.000 | 0.319 | 0.484 |
| TS02 | base | 30 | 5 | 9 | 0.857 | 0.769 | 0.811 |
| TS02 | v5 | 31 | 3 | 8 | 0.912 | 0.795 | 0.849 |
| TS02 | v6 | 31 | 3 | 8 | 0.912 | 0.795 | 0.849 |
| Scene miste TEST-ID | base | 158 | 230 | 145 | 0.407 | 0.521 | 0.457 |
| Scene miste TEST-ID | v5 | 153 | 228 | 150 | 0.402 | 0.505 | 0.447 |
| Scene miste TEST-ID | v6 | 135 | 90 | 168 | 0.600 | 0.446 | 0.511 |
...
| PKLot holdout | v5 | 282 | 62 | 1031 | 0.820 | 0.215 | 0.340 |
| PKLot holdout | v6 | 883 | 98 | 430 | 0.900 | 0.673 | 0.770 |
| Raspberry | base | 1693 | 97 | 3321 | 0.946 | 0.338 | 0.498 |
| Raspberry | v5 | 1781 | 116 | 3233 | 0.939 | 0.355 | 0.515 |
| Raspberry | v6 | 2088 | 244 | 2926 | 0.895 | 0.416 | 0.568 |
| TS02 | base | 638 | 23 | 233 | 0.965 | 0.732 | 0.833 |
| TS02 | v5 | 658 | 22 | 213 | 0.968 | 0.755 | 0.848 |
| TS02 | v6 | 650 | 32 | 221 | 0.953 | 0.746 | 0.837 |
| Scene miste TEST-ID | base | 244 | 304 | 199 | 0.445 | 0.551 | 0.492 |
| Scene miste TEST-ID | v5 | 240 | 309 | 203 | 0.437 | 0.542 | 0.484 |
| Scene miste TEST-ID | v6 | 212 | 198 | 231 | 0.517 | 0.479 | 0.497 |
...
| PKLot holdout | v5 | +0.432 | [+0.317; +0.525] | 6 / 0 / 0 |
| Raspberry | base | +0.073 | [+0.060; +0.088] | 11 / 0 / 0 |
| Raspberry | v5 | +0.055 | [+0.041; +0.070] | 11 / 0 / 0 |
| TS02 | base | +0.009 | [-0.008; +0.023] | 12 / 1 / 6 |
| TS02 | v5 | -0.006 | [-0.019; +0.008] | 7 / 4 / 8 |
| Scene miste TEST-ID | base | -0.149 | [-0.265; -0.033] | 5 / 182 / 6 |
| Scene miste TEST-ID | v5 | -0.148 | [-0.265; -0.035] | 3 / 184 / 6 |
...
Sulla validation la F1 globale sale da 0,455 (v5) a 0,468 (v6), ma i TP scendono da 232 a 216 e i FN salgono da 257 a 273; i FP scendono da 298 a 218. Migliorare F1 può significare meno falsi allarmi anche trovando meno oggetti.
...
| v5 | `252f302257759cae6d40579fb76b74d66f87bdce2997d44f89dba85d03420379` |
| v6 | `72521182fa0c90fec60fb1cd9f3b2ac113d16de476aaeea3a328508b7b2d0b30` |
