...
from training.evaluation.metrics import iou
from training.evaluation.prediction import Predictor
from .evaluation.protocol import guard_runtime
from .provenance import CONFIG, DATASET, ROOT, WORK, sha256, write
...
def deliver():
    ...
    paths = [delivery / f"yolo26n-phenocam.{suffix}" for suffix in ("pt", "onnx", "json")]
    pt_validation = json.loads((WORK / "evaluation/candidate-pt-fixed/runtime/runtime-metrics.json").read_text())
